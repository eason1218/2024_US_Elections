...
This project is motivated and guided by Rohan Alexander and his book [@tellingstories]. Data used in this paper was downloaded, cleaned and analyzed with the programming language **R** [@citeR]. Also with support of additional packages in R: `ggplot2` [@citeGgplot2], `rstan`  [@citeRstan], `dplyr` [@citeDplyr], `here` [@citeHere], `knitr` [@citeKnitr].
